...
from facing_direction import DOWN, UP, LEFT, RIGHT
import movement_direction
...
class Player(pygame.sprite.Sprite):
    def __init__(self, animations):
        ...
        self.__movement_direction = movement_direction.STAYING_STILL
        self.__state = "idle"
    ...
    def walk(self, direction):
        if direction == movement_direction.STAYING_STILL:
        ...
        if self.__state != "attack":
            self.__state = "walk"
            if self.__facing_direction != direction.facing_direction:
                self.__facing_direction = direction.facing_direction
                self.__index = 0
                self.image = self.__animations[self.__state][self.__facing_direction][self.__index]
                self.__timer = 0
                self.__walk_timer = 0
