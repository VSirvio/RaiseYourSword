...
from movement_direction import HorizontalDirection, MovementDirection, VerticalDirection
...
class ArrowKeys:
    ...
    def current_direction(self):
        ...
        return MovementDirection(vertical_direction, horizontal_direction)
